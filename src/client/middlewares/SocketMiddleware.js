import * as incomingEventType from '../constants/incomingEventTypes.js';
import * as outgoingEventType from '../constants/OutgoingEventTypes';
import { addBlockedRows, updateState } from '../actions';
import { NotificationManager } from 'react-notifications';

const MiddleWareSockets = (socket) => {
